      ...
      <div class="poll-form__question-card-header">
        ...
        <div class="poll-form__question-card-actions">
          <n-button
            ...
            :title="hasVotes ? lockedTitle : undefined"
            ...
            <div class="poll-form__option-inputs">
              ...
              <div class="poll-form__option-image-row">
                ...
                >
                  <button
                    type="button"
                    class="poll-form__option-image-trigger"
                    :aria-label="t('news.poll.openOptionImage', { number: oIdx + 1 })"
                    :data-lightbox-src="opt.image_url"
                    :data-lightbox-alt="opt.text || t('news.poll.optionNumber', { number: oIdx + 1 })"
                  >
                    <img
                      :src="opt.image_url"
                      :alt="opt.text || t('news.poll.optionNumber', { number: oIdx + 1 })"
                    >
                  </button>
                  <n-button
                    size="tiny"
...
.poll-form__option-image-trigger {
  display: block;
  border: 0;
  padding: 0;
