...
/* На мобильных карточка скрыта: в полную ширину она выше самого hero и
   blur-стеклом (backdrop-filter) накрывает приветствие. Время и погода
   на телефоне доступны на локскрине. Десктоп (>720px) — без изменений. */
