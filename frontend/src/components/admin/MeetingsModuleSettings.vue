    ...
    <template v-else>
      <section class="settings-section">
        ...
        <div class="branding-fields">
          ...
          <n-form-item
            :label="t('admin.modules.meetings.rsvpIngest')"
            :show-feedback="false"
          >
            <div class="rsvp-toggle">
              <n-switch v-model:value="form.rsvp_ingest_enabled" />
              <span class="rsvp-toggle__hint">{{ t('admin.modules.meetings.rsvpIngestHint') }}</span>
            </div>
          </n-form-item>
        </div>
...
import { NButton, NFormItem, NInputNumber, NSwitch, useMessage } from 'naive-ui'
...
watch(modulesData, (data) => {
  ...
  form.rsvp_ingest_enabled = data.meetings.rsvp_ingest_enabled
}, { immediate: true })
