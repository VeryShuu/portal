...
@media (max-width: 720px) {
  ...
  /* Горизонтальный скрим рассчитан на десктоп (текст слева, справа светлее).
     На мобильном текст занимает всю ширину — затемняем вертикально,
     темнее к низу, где подзаголовок. Тёмная тема — поверх той же логики. */
  .hero__scrim {
    background: linear-gradient(
      180deg,
      rgba(20, 50, 100, 0.35) 0%,
