...
// ── Остаточные типы, домигрированные на generated-схемы (audit M13) ──────────

export type KbTrashItem = components['schemas']['KbTrashItem']
export type KbTrashList = components['schemas']['KbTrashList']
export type DiffHunk = components['schemas']['DiffHunk']
export type DiffData = components['schemas']['DiffResponse']
export type PermEntry = components['schemas']['PermissionEntry']
export type UserSearchSubject = components['schemas']['SubjectSearchResult']
export type KbFile = components['schemas']['KbFilePublic']
