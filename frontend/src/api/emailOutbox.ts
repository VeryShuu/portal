...
// нет в OpenAPI — фронтовый тип (зеркалит ответ /admin/email-outbox)
...
// нет в OpenAPI — фронтовый тип (зеркалит ответ /admin/email-outbox/{id})
...
// нет в OpenAPI — фронтовый тип (набор query-параметров /admin/email-outbox)
