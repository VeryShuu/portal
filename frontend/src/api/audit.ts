...
// Audit-эндпоинты отдают untyped dict (нет Pydantic response-model) — в
// types.gen.d.ts схем для них нет.

// нет в OpenAPI — фронтовый тип (зеркалит ответ /audit)
...
// нет в OpenAPI — фронтовый тип (набор query-параметров /audit)
