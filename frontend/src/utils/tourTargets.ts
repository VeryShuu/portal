...
export const TOUR_TARGETS: TourTarget[] = [
  ...
  { selector: '.n-menu-item:has([data-tour-id="helpdesk-my"])', labelKey: 'nav.helpdesk', groupKey: 'nav.groups.services' },
  { selector: '.n-menu-item:has([data-tour-id="profile"])', labelKey: 'nav.profile', groupKey: 'nav.groups.account' },
  { selector: '.n-menu-item:has([data-tour-id="helpdesk-inbox"])', labelKey: 'nav.helpdeskInbox', groupKey: 'nav.groups.account' },
  { selector: '.n-menu-item:has([data-tour-id="settings"])', labelKey: 'nav.settings', groupKey: 'nav.groups.account' },
