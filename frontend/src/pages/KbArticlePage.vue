...
const renderedBody = computed(() => {
  ...
  // Список видео-хостингов — та же настройка, что у редактора и плеера learning
  const origins = brandingStore.settings.allowed_iframe_origins ?? DEFAULT_VIDEO_IFRAME_ORIGINS
  return sanitizeKbHtml(md.render(article.value.body), origins)
})
