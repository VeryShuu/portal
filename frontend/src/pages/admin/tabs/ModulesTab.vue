<template>
  <div class="branding-wrap">
    ...
    <ModuleCard style="margin-top:16px">
      <ModuleToggle
        :title="t('admin.modules.directum.title')"
        :hint="t('admin.modules.directum.hint')"
        :enabled="modulesForm.directum.enabled"
        :loading="directumToggling"
        :settings-label="t('admin.modules.openSettings')"
        @open-settings="goToDirectum"
        @update:enabled="onToggleDirectum"
      />
    </ModuleCard>

    <ModuleCard style="margin-top:16px">
      <ModuleToggle
        :title="t('admin.modules.learning.title')"
        :hint="t('admin.modules.learning.hint')"
        :enabled="modulesForm.learning.enabled"
        :loading="learningToggling"
        :settings-label="t('admin.modules.openSettings')"
        @open-settings="goToLearning"
        @update:enabled="onToggleLearning"
      />
    </ModuleCard>

    <ModuleCard style="margin-top:16px">
      <ModuleToggle
        :title="t('admin.modules.approvals.title')"
        :hint="t('admin.modules.approvals.hint')"
        :enabled="modulesForm.approvals.enabled"
        :loading="approvalsToggling"
        :settings-label="t('admin.modules.openSettings')"
        @open-settings="goToApprovals"
        @update:enabled="onToggleApprovals"
      />
    </ModuleCard>
