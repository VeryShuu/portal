<template>
  <div
    ...
    :data-monitoring-ready="MONITORING_READY"
...
const MONITORING_READY = 'home' as const
...
.home__side {
  flex: 0 0 340px;
  width: 340px;
  /* min-width: 0 — без него длинный nowrap-заголовок курса в виджете
     «Мои курсы» раздувает aside за пределы фиксированных 340px
     (автоматический минимум flex-элемента = min-content). */
  min-width: 0;
  display: flex;
