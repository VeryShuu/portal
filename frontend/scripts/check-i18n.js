...
if (extraInEn.length > 0) {
  // Аудит-3: лишние ключи en.json — ошибка, а не warning. Мастер — ru.json;
  // хвосты после удаления ru-ключа гниют молча и ломают синхронность.
  console.error('❌ Extra keys in en.json (not in ru.json):')
