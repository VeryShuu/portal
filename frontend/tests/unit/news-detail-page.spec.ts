...
vi.mock('../../src/queries/news', () => ({
  useNewsDetailQuery: vi.fn(() => ({ data: ref(undefined), isLoading: ref(false) })),
  useNewsGalleryQuery: vi.fn(() => ({ data: ref(undefined) })),
  useNewsAttachmentsQuery: vi.fn(() => ({ data: ref(undefined) })),
