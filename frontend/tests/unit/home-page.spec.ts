...
const MyCoursesWidgetStub = defineComponent({
  name: 'MyCoursesWidget',
  template: '<div class="my-courses-widget-stub" />',
})
...
const globalOptions = {
  ...
  stubs: {
    ...
    MyCoursesWidget: MyCoursesWidgetStub,
  },
}
...
describe('HomePage.vue', () => {
  ...
  it('exposes the stable synthetic monitoring marker', async () => {
    const wrapper = await mountPage()

    expect(wrapper.attributes('data-monitoring-ready')).toBe('home')
  })
