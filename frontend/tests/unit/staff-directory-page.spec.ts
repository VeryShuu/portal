...
import type { PaginatedResponse } from '../../src/api/index'
...
const mockStaffListQuery = vi.fn(() => ({
  data: ref<PaginatedResponse<UserPublic> | undefined>(undefined),
  isLoading: ref(false),
  isFetching: ref(false),
}))

vi.mock('../../src/queries/users', () => ({
  useStaffListQuery: (...args: Parameters<typeof mockStaffListQuery>) => mockStaffListQuery(...args),
