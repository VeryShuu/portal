...
describe('useAuthStore', () => {
  ...
  it('isEditor is false for reader', async () => {
    ...
    vi.mocked(fetchMe).mockResolvedValueOnce({
      ...
      lang: 'ru', preferences: {},
      auth_source: 'local', created_at: '2024-01-01T00:00:00Z', last_login_at: null,
      staff_hidden: false, gender: null,
      avatar_focal_x: null, avatar_focal_y: null, avatar_focal_zoom: null, birth_date: null,
    })
    const auth = useAuthStore()
    await auth.loadUser()
