...
vi.mock('../../src/api/files', () => ({
  ...
  previewFile: (...args: Parameters<typeof mockPreviewFile>) => mockPreviewFile(...args),
  isPreviewableImage: (...args: Parameters<typeof mockIsPreviewableImage>) => mockIsPreviewableImage(...args),
  isPreviewablePdf: (...args: Parameters<typeof mockIsPreviewablePdf>) => mockIsPreviewablePdf(...args),
}))
