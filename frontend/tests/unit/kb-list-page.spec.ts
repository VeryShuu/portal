...
vi.mock('../../src/composables/useManageDrawer', () => ({
  useManageDrawer: vi.fn(() => ({
    ...
    is: (...args: Parameters<typeof mockManageIs>) => mockManageIs(...args),
  })),
}))
...
vi.mock('../../src/composables/useKbSections', () => ({
  useKbSections: (...args: Parameters<typeof mockUseKbSections>) => mockUseKbSections(...args),
...
vi.mock('../../src/composables/useKbArticleListing', () => ({
  useKbArticleListing: (...args: Parameters<typeof mockUseKbArticleListing>) => mockUseKbArticleListing(...args),
}))
