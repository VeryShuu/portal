...
vi.mock('../../src/components/editor/extensions/IframeEmbed', () => ({
  IframeEmbed: { configure: () => ({}) },
}))
vi.mock('../../src/stores/branding', () => ({
  useBrandingStore: () => ({ settings: {} }),
}))
...
vi.mock('../../src/components/editor/useEditorImageUpload', () => ({
  useEditorImageUpload: () => ({
    fileInputRef: ref<HTMLInputElement | null>(null), triggerImageUpload: vi.fn(), handleFileInputChange: vi.fn(),
