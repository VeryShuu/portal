...
vi.mock('../../src/api/news', () => ({
  fetchNewsList: (...args: Parameters<typeof fetchNewsListMock>) => fetchNewsListMock(...args),
}))
...
vi.mock('../../src/composables/useConfirmDialog', () => ({
  useConfirmDialog: vi.fn(() => ({ confirm: (...args: Parameters<typeof confirmFn>) => confirmFn(...args) })),
}))
