...
import type { PhotoFolderTreeNode } from '../../src/api/photos'
...
const makeNode = (id: string): PhotoFolderTreeNode => ({ id, name: `Folder ${id}`, path: `/${id}`, slug: id, parent_id: null, permission: 'manager', children: [] })
const makeTag = (id: string, name: string) => ({ id, name, slug: id, usage_count: 1 })
