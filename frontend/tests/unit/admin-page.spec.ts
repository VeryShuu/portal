...
describe('AdminPage tab decomposition', () => {
  ...
  it('MatrixTab is a valid Vue component file', async () => {
    const tab = await import('../../src/pages/admin/tabs/MatrixTab.vue')
    expect(tab.default).toBeDefined()
  })

  it('MessengerOutboxTab is a valid Vue component file', async () => {
    const tab = await import('../../src/pages/admin/tabs/MessengerOutboxTab.vue')
    expect(tab.default).toBeDefined()
  })
})
