...
import type { DirectoryPublic, EntryPublic } from '../../src/api/directories'
...
vi.mock('naive-ui', () => ({
  ...
  NInput: {
    ...
    props: ['value', 'type', 'placeholder', 'clearable', 'autosize', 'size'],
    emits: ['update:value'],
  },
...
const directory: DirectoryPublic = {
  id: 'd1',
  slug: 'fleet',
  label_ru: 'Флот',
  label_en: 'Fleet',
...
async function mountDrawer(entry: EntryPublic | null) {
