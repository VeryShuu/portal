...
> Последнее обновление: апрель 2026 (ADR-033 — files_acl_persistence; ADR-034 — Hardening по результатам ревью)
...
## ADR-033: files_acl_persistence — JSON-хранилище ACL файлового менеджера
