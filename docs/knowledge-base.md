...
| `./backend/app/api/kb/*_repo.py` | Запросный слой (sections_repo, permissions_repo, comments_repo, attachments_repo, trash_repo, versions_repo, export_import_repo) — SQL-выборки, вынесенные из роутеров. |
