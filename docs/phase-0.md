...
> **Статус:** этот документ описывает Phase 0 (инфраструктуру), которая полностью завершена.
> Файл сохранён в архивных целях — для понимания истории фиксов и smoke-test процедур.
