...
> **Последнее обновление:** 2026-07-20 (после remediation аудита 2026-07-20: декомпозиция 3 D-функций → ≤ C, CI-gate по radon F→D, email_signature min-pos + company-маркеры в константы; все 11 пунктов P1+P2+P3 закрыты).
...
> **Масштаб:** backend ~55k LOC, frontend ~60k LOC реального кода, **84 миграции** (075–084 — модуль Helpdesk + MAX-messenger; детали в `./helpdesk.md`), 3669 backend-тестов + 2111 frontend-spec.
