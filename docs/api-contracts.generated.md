...
<!-- Generated: 2026-09-07 10:30 UTC -->
...
- [meetings](#meetings)
- [messenger-outbox](#messenger-outbox)
- [modules](#modules)
...
| Status | Description | Schema |
|--------|-------------|--------|
| 200 | Successful Response | `MatrixBotSettingsOut` |
| 422 | Validation Error | `HTTPValidationError` |

### `PUT /api/v1/admin/matrix-bot`
...
Content-Type: `application/json` — schema: `MatrixBotSettingsIn`
...
### `POST /api/v1/admin/matrix-bot/test`
...
| Status | Description | Schema |
|--------|-------------|--------|
| 200 | Successful Response | `MatrixBotTestResult` |
| 422 | Validation Error | `HTTPValidationError` |

### `GET /api/v1/admin/messenger-outbox`
...
### `GET /api/v1/admin/messenger-outbox/{outbox_id}`
...
### `POST /api/v1/admin/messenger-outbox/{outbox_id}/cancel`
...
### `POST /api/v1/admin/messenger-outbox/{outbox_id}/retry`
...
| Status | Description | Schema |
|--------|-------------|--------|
| 200 | Successful Response | `ApprovalDocumentList` |
| 422 | Validation Error | `HTTPValidationError` |
...
Content-Type: `application/json` — schema: `BulkApproveIn`
...
| Status | Description | Schema |
|--------|-------------|--------|
| 200 | Successful Response | `BulkApproveOut` |
| 422 | Validation Error | `HTTPValidationError` |
...
| Status | Description | Schema |
|--------|-------------|--------|
| 200 | Successful Response | `ApprovalsSettingsOut` |
| 422 | Validation Error | `HTTPValidationError` |
...
Content-Type: `application/json` — schema: `ApprovalsSettingsIn`
...
| Status | Description | Schema |
|--------|-------------|--------|
| 200 | Successful Response | `ApprovalsTestResult` |
| 422 | Validation Error | `HTTPValidationError` |

### `GET /api/v1/approvals/{document_uuid}`
...
| Status | Description | Schema |
|--------|-------------|--------|
| 200 | Successful Response | `ApprovalDocumentDetail` |
| 422 | Validation Error | `HTTPValidationError` |

### `POST /api/v1/approvals/{document_uuid}/approve`
...
Content-Type: `application/json` — schema: `ApproveIn`
...
| Status | Description | Schema |
|--------|-------------|--------|
| 200 | Successful Response | `ActionOut` |
| 422 | Validation Error | `HTTPValidationError` |

### `GET /api/v1/approvals/{document_uuid}/attachments/{index}`
...
### `POST /api/v1/approvals/{document_uuid}/reject`
...
Content-Type: `application/json` — schema: `RejectIn`
...
### `POST /api/v1/auth/learning/login`

**Запрос кода входа (шаг 1)**

**Request Body**

Content-Type: `application/json` — schema: `LearningLoginRequest`
...
### `POST /api/v1/auth/learning/logout`
...
### `POST /api/v1/auth/learning/verify`

**Вход по коду из письма (шаг 2)**

**Request Body**

Content-Type: `application/json` — schema: `LearningVerifyRequest`
...
| Status | Description | Schema |
|--------|-------------|--------|
| 200 | Successful Response | `DirectumRunNowResponse` |
| 422 | Validation Error | `HTTPValidationError` |

### `GET /api/v1/directum/runs`
...
| Status | Description | Schema |
|--------|-------------|--------|
| 200 | Successful Response | `DirectumRunList` |
| 422 | Validation Error | `HTTPValidationError` |

### `GET /api/v1/directum/runs/{run_id}`
...
| Status | Description | Schema |
|--------|-------------|--------|
| 200 | Successful Response | `DirectumRunOut` |
| 422 | Validation Error | `HTTPValidationError` |

### `GET /api/v1/directum/settings`
...
| Status | Description | Schema |
|--------|-------------|--------|
| 200 | Successful Response | `DirectumSettingsOut` |
| 422 | Validation Error | `HTTPValidationError` |

### `PUT /api/v1/directum/settings`
...
Content-Type: `application/json` — schema: `DirectumSettingsIn`
...
| `auth_username` | any |  |  |
| `auth_password` | any |  |  |
| `overdue_run_hours` | array of integer |  |  |
...
| Status | Description | Schema |
|--------|-------------|--------|
| 200 | Successful Response | `DirectumTestResult` |
| 422 | Validation Error | `HTTPValidationError` |
...
### `GET /api/v1/helpdesk/tickets/{ticket_id}/archive-attachments/{filename}`
...
### `GET /api/v1/learning/admin/accounts`
...
| Status | Description | Schema |
|--------|-------------|--------|
| 200 | Successful Response | `LearningAccountListOut` |
| 422 | Validation Error | `HTTPValidationError` |

### `POST /api/v1/learning/admin/accounts`
...
Content-Type: `application/json` — schema: `LearningAccountCreate`
...
| Status | Description | Schema |
|--------|-------------|--------|
| 201 | Successful Response | `LearningAccountOut` |
| 422 | Validation Error | `HTTPValidationError` |

### `POST /api/v1/learning/admin/accounts/import`
...
Content-Type: `multipart/form-data` — schema: `Body_import_accounts_api_v1_learning_admin_accounts_import_post`
...
| Status | Description | Schema |
|--------|-------------|--------|
| 200 | Successful Response | `LearningAccountImportOut` |
| 422 | Validation Error | `HTTPValidationError` |

### `GET /api/v1/learning/admin/accounts/template`
...
### `POST /api/v1/learning/admin/accounts/{account_id}/block`
...
### `POST /api/v1/learning/admin/accounts/{account_id}/login-code`
...
| Status | Description | Schema |
|--------|-------------|--------|
| 200 | Successful Response | `LearningLoginCodeOut` |
| 422 | Validation Error | `HTTPValidationError` |

### `POST /api/v1/learning/admin/accounts/{account_id}/unblock`
...
### `GET /api/v1/learning/admin/categories`
...
| Status | Description | Schema |
|--------|-------------|--------|
| 200 | Successful Response | array of `CategoryOut` |
| 422 | Validation Error | `HTTPValidationError` |

### `POST /api/v1/learning/admin/categories`
...
Content-Type: `application/json` — schema: `CategoryCreate`
...
| Status | Description | Schema |
|--------|-------------|--------|
| 201 | Successful Response | `CategoryOut` |
| 422 | Validation Error | `HTTPValidationError` |

### `POST /api/v1/learning/admin/categories/reorder`
...
Content-Type: `application/json` — schema: `CategoryReorder`

| Field | Type | Required | Description |
|-------|------|----------|-------------|
| `ordered_ids` | array of string | ✓ |  |
...
### `PATCH /api/v1/learning/admin/categories/{category_id}`
...
Content-Type: `application/json` — schema: `CategoryUpdate`
...
| Status | Description | Schema |
|--------|-------------|--------|
| 200 | Successful Response | `CategoryOut` |
| 422 | Validation Error | `HTTPValidationError` |

### `DELETE /api/v1/learning/admin/categories/{category_id}`
...
### `GET /api/v1/learning/admin/courses`
...
| Status | Description | Schema |
|--------|-------------|--------|
| 200 | Successful Response | `CourseListOut` |
| 422 | Validation Error | `HTTPValidationError` |

### `POST /api/v1/learning/admin/courses`
...
Content-Type: `application/json` — schema: `CourseCreate`
...
| Status | Description | Schema |
|--------|-------------|--------|
| 201 | Successful Response | `CourseOut` |
| 422 | Validation Error | `HTTPValidationError` |

### `PATCH /api/v1/learning/admin/courses/items/{item_id}`
...
Content-Type: `application/json` — schema: `ItemUpdate`
...
### `DELETE /api/v1/learning/admin/courses/items/{item_id}`
...
### `POST /api/v1/learning/admin/courses/items/{item_id}/file`
...
Content-Type: `multipart/form-data` — schema: `Body_upload_material_file_api_v1_learning_admin_courses_items__item_id__file_post`
...
### `POST /api/v1/learning/admin/courses/items/{item_id}/questions`
...
Content-Type: `application/json` — schema: `QuestionCreate`

| Field | Type | Required | Description |
|-------|------|----------|-------------|
| `text` | string | ✓ |  |
| `multi` | boolean |  |  |
| `options` | array of `OptionIn` | ✓ |  |
...
### `POST /api/v1/learning/admin/courses/items/{item_id}/questions/import`
...
Content-Type: `multipart/form-data` — schema: `Body_import_questions_api_v1_learning_admin_courses_items__item_id__questions_import_post`
...
### `POST /api/v1/learning/admin/courses/items/{item_id}/questions/import/preview`
...
Content-Type: `multipart/form-data` — schema: `Body_preview_questions_import_api_v1_learning_admin_courses_items__item_id__questions_import_preview_post`
...
### `GET /api/v1/learning/admin/courses/items/{item_id}/questions/template`
...
### `PATCH /api/v1/learning/admin/courses/items/{item_id}/questions/{question_id}`
...
### `DELETE /api/v1/learning/admin/courses/items/{item_id}/questions/{question_id}`
...
### `GET /api/v1/learning/admin/courses/items/{item_id}/test`
...
### `PATCH /api/v1/learning/admin/courses/items/{item_id}/test`
...
Content-Type: `application/json` — schema: `TestSettingsUpdate`
...
### `GET /api/v1/learning/admin/courses/{course_id}`
...
| Status | Description | Schema |
|--------|-------------|--------|
| 200 | Successful Response | `CourseDetailOut` |
| 422 | Validation Error | `HTTPValidationError` |

### `PATCH /api/v1/learning/admin/courses/{course_id}`
...
Content-Type: `application/json` — schema: `CourseUpdate`
...
| Status | Description | Schema |
|--------|-------------|--------|
| 200 | Successful Response | `CourseOut` |
| 422 | Validation Error | `HTTPValidationError` |

### `DELETE /api/v1/learning/admin/courses/{course_id}`
...
### `GET /api/v1/learning/admin/courses/{course_id}/cover`
...
### `POST /api/v1/learning/admin/courses/{course_id}/cover`
...
Content-Type: `multipart/form-data` — schema: `Body_upload_course_cover_api_v1_learning_admin_courses__course_id__cover_post`
...
### `DELETE /api/v1/learning/admin/courses/{course_id}/cover`
...
### `POST /api/v1/learning/admin/courses/{course_id}/items`
...
Content-Type: `application/json` — schema: `ItemCreate`
...
### `POST /api/v1/learning/admin/courses/{course_id}/items/reorder`
...
Content-Type: `application/json` — schema: `ItemsReorder`
...
### `POST /api/v1/learning/admin/courses/{course_id}/participants`
...
Content-Type: `application/json` — schema: `ParticipantEnroll`

| Field | Type | Required | Description |
|-------|------|----------|-------------|
| `user_id` | any |  |  |
| `learning_account_id` | any |  |  |
...
### `POST /api/v1/learning/admin/courses/{course_id}/participants/bulk`
...
Content-Type: `application/json` — schema: `ParticipantBulkEnroll`
...
### `DELETE /api/v1/learning/admin/courses/{course_id}/participants/{participant_id}`
...
### `GET /api/v1/learning/admin/courses/{course_id}/participants/{participant_id}/certificate`
...
### `GET /api/v1/learning/admin/courses/{course_id}/participants/{participant_id}/items`
...
| Status | Description | Schema |
|--------|-------------|--------|
| 200 | Successful Response | `ParticipantItemsOut` |
| 422 | Validation Error | `HTTPValidationError` |

### `POST /api/v1/learning/admin/courses/{course_id}/participants/{participant_id}/items/{item_id}/reset-attempts`
...
| Status | Description | Schema |
|--------|-------------|--------|
| 200 | Successful Response | `ParticipantAttemptsResetOut` |
| 422 | Validation Error | `HTTPValidationError` |

### `GET /api/v1/learning/admin/courses/{course_id}/progress`
...
### `GET /api/v1/learning/admin/courses/{course_id}/progress/export`
...
### `POST /api/v1/learning/admin/courses/{course_id}/publish`
...
### `POST /api/v1/learning/admin/courses/{course_id}/unpublish`
...
| Status | Description | Schema |
|--------|-------------|--------|
| 200 | Successful Response | array of `LearningAdminOut` |
| 422 | Validation Error | `HTTPValidationError` |

### `POST /api/v1/learning/admins`
...
Content-Type: `application/json` — schema: `LearningAdminCreate`
...
### `DELETE /api/v1/learning/admins/{user_id}`
...
### `GET /api/v1/learning/me/attempts/{attempt_id}`
...
| Name | In | Type | Required | Description |
|------|----|------|----------|-------------|
| `attempt_id` | path | `string` | ✓ |  |
| `learning_session` | cookie | `any` |  |  |
| `portal_session` | cookie | `any` |  |  |
...
### `POST /api/v1/learning/me/attempts/{attempt_id}/submit`
...
Content-Type: `application/json` — schema: `SubmitAnswers`
...
| Status | Description | Schema |
|--------|-------------|--------|
| 200 | Successful Response | `AttemptResult` |
| 422 | Validation Error | `HTTPValidationError` |

### `GET /api/v1/learning/me/courses`
...
| Status | Description | Schema |
|--------|-------------|--------|
| 200 | Successful Response | array of `MyCourseOut` |
| 422 | Validation Error | `HTTPValidationError` |

### `GET /api/v1/learning/me/courses/{slug}`
...
| Status | Description | Schema |
|--------|-------------|--------|
| 200 | Successful Response | `MyCourseDetailOut` |
| 422 | Validation Error | `HTTPValidationError` |

### `GET /api/v1/learning/me/courses/{slug}/certificate`
...
### `GET /api/v1/learning/me/courses/{slug}/cover`
...
### `POST /api/v1/learning/me/items/{item_id}/complete`
...
### `GET /api/v1/learning/me/items/{item_id}/file`
...
### `POST /api/v1/learning/me/tests/{item_id}/attempts`
...
| Status | Description | Schema |
|--------|-------------|--------|
| 200 | Successful Response | `AttemptView` |
| 422 | Validation Error | `HTTPValidationError` |

### `GET /api/v1/learning/me/tests/{item_id}/my-attempts`
...
| Status | Description | Schema |
|--------|-------------|--------|
| 200 | Successful Response | `MyAttemptsOut` |
| 422 | Validation Error | `HTTPValidationError` |

### `GET /api/v1/learning/meta`
...
| Status | Description | Schema |
|--------|-------------|--------|
| 200 | Successful Response | `LearningMetaOut` |
...
### `POST /api/v1/meetings/participants/absences`

**Participant Absences**

Действующие отсутствия участников на дату встречи (не «на сегодня»).
...
Content-Type: `application/json` — schema: `ParticipantAbsencesRequest`
...
### `PUT /api/v1/admin/modules/approvals`
...
Content-Type: `application/json` — schema: `ApprovalsModuleIn`
...
| Status | Description | Schema |
|--------|-------------|--------|
| 200 | Successful Response | `ApprovalsModuleOut` |
| 422 | Validation Error | `HTTPValidationError` |
...
### `PUT /api/v1/admin/modules/directum`
...
Content-Type: `application/json` — schema: `DirectumModuleIn`
...
| Status | Description | Schema |
|--------|-------------|--------|
| 200 | Successful Response | `DirectumModuleOut` |
| 422 | Validation Error | `HTTPValidationError` |
...
### `PUT /api/v1/admin/modules/learning`
...
Content-Type: `application/json` — schema: `LearningModuleIn`
...
| Status | Description | Schema |
|--------|-------------|--------|
| 200 | Successful Response | `LearningModuleOut` |
| 422 | Validation Error | `HTTPValidationError` |
...
| `video_iframe_origins` | array of string |  |  |
...
### `GET /api/v1/admin/system/settings/onboarding/stats`
...
| Status | Description | Schema |
|--------|-------------|--------|
| 200 | Successful Response | `OnboardingStatsOut` |
| 422 | Validation Error | `HTTPValidationError` |
...
### `POST /api/v1/users/admin/{user_id}/avatar`
...
Content-Type: `multipart/form-data` — schema: `Body_admin_upload_avatar_api_v1_users_admin__user_id__avatar_post`
...
### `DELETE /api/v1/users/admin/{user_id}/avatar`
...
### `GET /api/v1/users/admin/{user_id}/notification-preferences`
...
| Status | Description | Schema |
|--------|-------------|--------|
| 200 | Successful Response | `UserNotificationPreferencesOut` |
| 422 | Validation Error | `HTTPValidationError` |

### `PATCH /api/v1/users/admin/{user_id}/notification-preferences`
...
Content-Type: `application/json` — schema: `AdminPatchPreferencesRequest`

| Field | Type | Required | Description |
|-------|------|----------|-------------|
| `chat_notifications_enabled` | any |  |  |
