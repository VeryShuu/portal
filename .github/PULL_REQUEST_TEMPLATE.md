<!--
  ...
  См. AGENTS.md §«Работа между сессиями» — main защищена, 16 обязательных чеков.
-->
...
- [ ] **Rename колонки/таблиц** —_expand→ писать в оба → читать новое → удалить старое (≥ 2 миграции).
