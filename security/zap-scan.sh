...
# Зеркало ghcr.io/zaproxy/zaproxy:stable (digest исходника: 8d387b1a63e3…).
# ghcr.io недостижим с раннера (инцидент 2026-08-24) — зеркало в своём registry,
# обновление — docs/forgejo-runner-setup.md §«Зеркало ghcr-образов».
# @sha256 — иммутабельный пин самого зеркала (аудит-3).
ZAP_IMAGE="forgejo.mage.ru/mage/zaproxy:stable-8d387b1a@sha256:c558ee87358911ab17278c70991e856f57793e115d9cd0f88ca475cf82907a1a"
