...
def register_routers(app: FastAPI) -> None:
    ...
    from app.api.directum import router as directum_router
    ...
    from app.api.matrix_bot import router as matrix_bot_router
    ...
    from app.api.messenger_outbox import router as messenger_outbox_router
    ...
    app.include_router(matrix_bot_router, prefix="/api/v1")
    app.include_router(messenger_outbox_router, prefix="/api/v1")
    app.include_router(erp_sync_router, prefix="/api/v1")
    app.include_router(directum_router, prefix="/api/v1")
