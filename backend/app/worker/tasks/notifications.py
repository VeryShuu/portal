...
async def notify_news_published(
    ...
    *,
    ...
    """Отправляет email-уведомления пользователям об опубликованной новости."""
    import asyncpg
    ...
    try:
        ...
        news_link = f"{settings.portal_base_url}/news/{news_id}"
...
async def notify_suggestion_reviewed_email(
    ...
    *,
    ...
    article_link = f"{settings.portal_base_url}/kb/articles/{article_id}"
    portal_name = "Корпоративный портал"
