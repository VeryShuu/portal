...
KNOWN_EVENT_TYPES: frozenset[str] = frozenset(
    {
        ...
        # --- approvals (согласование документов из 1С) ----------------------
        "approvals.approved",
        "approvals.bulk_approved",
        "approvals.rejected",
        "approvals.settings_updated",
        # --- directum -------------------------------------------------------
        ...
        "learning.account_blocked",
        "learning.account_created",
        "learning.accounts_imported",
        "learning.account_unblocked",
        "learning.admin_assigned",
        "learning.admin_revoked",
        "learning.attempts_reset",
        "learning.categories_reordered",
        "learning.category_created",
        "learning.category_deleted",
        "learning.category_updated",
        "learning.certificate_issued",
        "learning.course_cover_deleted",
        "learning.course_cover_uploaded",
        "learning.course_created",
        "learning.course_deleted",
        "learning.course_published",
        "learning.course_updated",
        "learning.item_created",
        "learning.item_deleted",
        "learning.item_updated",
        "learning.items_reordered",
        "learning.login",
        "learning.login_code_issued",
        "learning.material_uploaded",
        "learning.participant_enrolled",
        "learning.participant_removed",
        "learning.participants_bulk_enrolled",
        "learning.question_added",
        "learning.question_deleted",
        "learning.question_updated",
        "learning.questions_imported",
        "learning.test_settings_updated",
        # --- matrix ---------------------------------------------------------
        "matrix.bot_settings_changed",
        # --- links ----------------------------------------------------------
        "links.created",
        "links.deleted",
        "links.reordered",
