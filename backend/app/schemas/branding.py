...
class EmailSettings(BaseModel):
    ...
    # Отображаемое имя отправителя (RFC 5322 display name): "Портал Маге
    # <portal@mage.ru>" вместо голого адреса. Также подставляется как CN
    # организатора iCal-приглашений при RSVP-инджесте (ORGANIZER = адрес
    # портала) — чтобы клиенты не показывали «ФИО сотрудника <portal@…>»
    # и ответы не уходили на общий ящик портала.
