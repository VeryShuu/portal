...
class ApprovalsDailyPoint(BaseModel):
    day: date | None = None
    approved: int
    rejected: int


class ApprovalsUsage(BaseModel):
    """Использование модуля «Согласование 1С» за окно series (``days``).
    ...
    daily: list[ApprovalsDailyPoint]
