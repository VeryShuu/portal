...
class TestLogos:
    def test_table_layout_has_stable_helpdesk_marker(self):
        html = svc.render_signature(_req(device="PC"), _SETTINGS).html
        assert 'data-portal-email-signature="mage-v1"' in html
...
class TestPhoneLayout:
    def test_has_stable_helpdesk_marker(self):
